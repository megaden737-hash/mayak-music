  ...
  return (
    ...
    >
      <div className="max-w-2xl">
        ...
        <h2 className="font-display text-3xl leading-[1.05] tracking-tight text-foreground md:text-5xl">
          {title}
        </h2>
        {description && (
          <p className="mt-3 max-w-xl text-base text-foreground/60 md:text-lg">
            {description}
          </p>
        )}
      </div>
